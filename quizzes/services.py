...
def build_prompt(chunks: list[str], question_count: int) -> str:
    ...
    instructions = textwrap.dedent(
        ...
        Each question must have four answer choices, indicate the correct answer, and include a short explanation referencing the source material.
...
def call_gemini(prompt: str) -> dict:
    ...
    try:
        ...
        raise GeminiError("Unexpected response from Gemini API.")
